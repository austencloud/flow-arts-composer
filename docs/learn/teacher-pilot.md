...
| Motion paths reference, September 8; [copy review](copy-reviews/motion-paths.md)                                                                                                            | New public comparison explorer and reference; larger interaction/handoff | Inline lead; September 5 briefing                          | September 13 reviews requested matrix selection and playback continuity; revision pending review                                 | Unknown / unknown / two observed substantial September 13 rounds                    | Unknown / unknown          | Matrix selection and playback-continuity preferences; same reference task |
