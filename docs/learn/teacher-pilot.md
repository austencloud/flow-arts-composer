...
| Motion paths reference, September 8; [copy review](copy-reviews/motion-paths.md)                                                                                                            | New public comparison explorer and reference; larger interaction/handoff | Inline lead; September 5 briefing                          | September 13 review requested matrix selection; revision pending review                                                          | Unknown / unknown / one observed substantial September 13 round                     | Unknown / unknown          | New matrix-selection preference; continuation of the same reference task |
