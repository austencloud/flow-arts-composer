...
1. **Run the mechanical pre-pass first.** The script ships next to this file.
   ...
   ```
   python .agents/skills/ai-bust/ai_bust.py FILE [FILE ...]
   python .agents/skills/ai-bust/ai_bust.py src/routes/notation/*/+page.svelte
   echo "pasted text" | python .agents/skills/ai-bust/ai_bust.py -
   python .agents/skills/ai-bust/ai_bust.py --json --min-severity HIGH FILE
   python .agents/skills/ai-bust/ai_bust.py --self-test
   ```
...
```
python .agents/skills/ai-bust/ai_bust.py --email draft.txt
python .agents/skills/ai-bust/ai_bust.py --email --require-contact "PHONE_REGEX" draft.html
```
