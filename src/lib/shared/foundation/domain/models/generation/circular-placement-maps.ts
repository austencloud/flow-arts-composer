...
/**
 * Half placement map - 180° rotation
...
export const HALF_PLACEMENT_MAP: Record<GridPlacement, GridPlacement> = {
  ...
  // Zeta 1-8 placements (135° obtuse angle)
  ...
  // Eta 1-8 placements (45° acute angle)
  ...
  // Tau placements - 180° rotation switches which hand is at center
...
/**
 * Quarter placement map - Clockwise 90° rotation
 * Maps each placement to 2 placements clockwise (for box grid)
 */
export const QUARTER_PLACEMENT_MAP_CW: Record<GridPlacement, GridPlacement> = {
  ...
  // Zeta 1-8 placements (90° CW = +2 placements)
  ...
  // Eta 1-8 placements (90° CW = +2 placements)
  ...
  // Tau 1-8 placements (90° CW = +2 placements within group)
...
/**
 * Quarter placement map - Counter-clockwise 90° rotation
 * Maps each placement to 2 placements counter-clockwise (for box grid)
 */
export const QUARTER_PLACEMENT_MAP_CCW: Record<GridPlacement, GridPlacement> = {
  ...
  // Zeta 1-8 placements (90° CCW = -2 placements = +6 mod 8)
  ...
  // Eta 1-8 placements (90° CCW = -2 placements = +6 mod 8)
  ...
  // Tau 1-8 placements (90° CCW = -2 placements = +6 mod 8)
